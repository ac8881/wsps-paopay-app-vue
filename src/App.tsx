...
function App() {
  ...
  return (
    <div className="w-full h-max py-12">
      <Navbar
        rightIcon={
      ...
      <div className='w-full'>
        <div className="w-full flex flex-col divide-y divide-dashed gap-y-4">
          ...
          <div className='divide-x divide-dashed grid grid-cols-3 w-full'>
